                            ...
                            <div class="col-md-6 mt-0">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-custom <?= isset($errors['warranty']) ? ' is-invalid' : '' ?>" name="warranty"
                                        value="<?= isset($old['warranty']) ? $this->e($old['warranty']) : '' ?>" placeholder="Bảo hành">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-custom <?= isset($errors['processor']) ? ' is-invalid' : '' ?>" name="processor"
                                        value="<?= isset($old['processor']) ? $this->e($old['processor']) : '' ?>" placeholder="Chip xử lý">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control form-control-custom <?= isset($errors['release_date']) ? ' is-invalid' : '' ?>" name="release_date"
                                        value="<?= isset($old['release_date']) ? $this->e($old['release_date']) : '' ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select form-control-custom <?= isset($errors['storage']) ? ' is-invalid' : '' ?>" name="storage">
                                        <option value="64GB" <?= isset($old['storage']) && $old['storage'] == '64GB' ? 'selected' : '' ?>>64GB</option>
                                        <option value="128GB" <?= isset($old['storage']) && $old['storage'] == '128GB' ? 'selected' : '' ?>>128GB</option>
                                        <option value="256GB" <?= isset($old['storage']) && $old['storage'] == '256GB' ? 'selected' : '' ?>>256GB</option>
                                        <option value="512GB" <?= isset($old['storage']) && $old['storage'] == '512GB' ? 'selected' : '' ?>>512GB</option>
                                        <option value="1TB" <?= isset($old['storage']) && $old['storage'] == '1TB' ? 'selected' : '' ?>>1TB</option>
                                    </select>
                                    <label>Bộ Nhớ</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-custom <?= isset($errors['color']) ? ' is-invalid' : '' ?>" name="color"
                                        value="<?= isset($old['color']) ? $this->e($old['color']) : '' ?>" placeholder="Màu sắc">
                                    <label>Màu Sắc</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-custom <?= isset($errors['resolution']) ? ' is-invalid' : '' ?>" name="resolution"
                                        value="<?= isset($old['resolution']) ? $this->e($old['resolution']) : '' ?>" placeholder="Độ phân giải màn hình" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" step="0.1" class="form-control form-control-custom <?= isset($errors['screen_size']) ? ' is-invalid' : '' ?>" name="screen_size"
                                        value="<?= isset($old['screen_size']) ? $this->e($old['screen_size']) : '' ?>" placeholder="Kích thước màn hình" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-custom <?= isset($errors['screen_technology']) ? ' is-invalid' : '' ?>" name="screen_technology"
                                        value="<?= isset($old['screen_technology']) ? $this->e($old['screen_technology']) : '' ?>" placeholder="Công nghệ màn hình" required>
